  ...
  <form class="dashboard-form"  enctype="multipart/form-data" action="<?php echo CURRENT_URL; ?>" method="post">
    <section class="row">
      <div class="col-md-6 col-sm-12">
        ...
        <?php } else { echo '<p class="accent">Upload an image/avatar here.</p>'; } ?>
        </div>
        <div class="form-group">
      ...
      <div class="col-md-6 col-sm-12">
        ...
        <div class="form-group">
          ...
          <textarea name="description" id="description" placeholder="Description" value="" rows="8"><?php echo $data['description']; ?></textarea>
        </div>
      <?php } ?>
      <?php if(IS_VOLUNTEER) {
        echo '<a class="btn btn-success certificate-btn" target="_blank" href="' . URL_BASE . 'certificate" title="certificate" role="button">Get Certificate</a>';
      } ?>
      </div>
    </section>
